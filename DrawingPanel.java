  ...
  implements MouseListener, MouseMotionListener, KeyListener
{
  ...
  public void addBalloon(int shape)
  {
    ...
    int w = getWidth();
    int h = getHeight();
    int radius = 100 + (int)(Math.random() * w / 2);
    switch (shape)
    {
    case 1: System.out.println("Spot #9");activeBalloon = new RoundBalloon();System.out.println("Spot #6"); break;
      ...
      default: activeBalloon = new RoundBalloon(); break;
    }
  ...
  public void paintComponent(Graphics g)
  {
    ...
    System.out.println("Spot #10");
    //activeBalloon.draw(g, true);
    System.out.println("Spot #11");
